...
Load/edit existing wafer maps (.txt/.map/.csv)
Interactive wafer grid with click‑to‑edit cells
Live Raw Output editor (auto‑re-parses map)
Auto‑detect die pitch

Requirements

Python 3.8+, no extra packages (Tkinter included)
